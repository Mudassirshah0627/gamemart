...
const RecentlyAddedGames = memo(function RecentlyAddedGames() {
  const responsive = {
    superbLargeDesktop: {
  ...
  return (
    <div className="bg-[#2E2D2E] border-2 border-[#424142] mt-4 rounded-[40px] pb-12">
      <motion.div
        ...
        className="text-white font-Poppins text-2xl sm:text-[41.335px]  font-normal leading-normal my-4 pb- px-12 flex items-center justify-between pt-6"
      >
        Recently Added
        <BsArrowRight />
      </motion.div>
